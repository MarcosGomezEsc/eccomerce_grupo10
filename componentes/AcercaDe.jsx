    ...
    <section className="acercaDee">
        ...
        <div className="sectionData3">
            ...
            <p>Muy fácil. Agarramos botellas de plástico. Nooo se preocupe, están en lavandina un bueen tiempo,
                ...
                Pasado su tiempo, le agregamos por esa corteplástico que nos devuelve tiritas de plástico, tenemos una booocha de material
            </p>
        <div className="imgSection2">
            <img src="https://via.placeholder.com/250x250" alt="" />
        </div>
        <p>Pasado Luego por el calentador de materiales, logramos conseguir
            obtener el filamento buscado para que este sea de rápido acceso
            a nuestra impresora 3d SI SI, hecho por nosotros mismos!!!
            !!!
        </p>
        </div>
